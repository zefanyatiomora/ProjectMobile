...
import 'laporkan_progres_agenda2_page.dart'; 

class LaporkanProgresAgendaPage extends StatelessWidget { 
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => LaporkanProgressAgenda2Page(kegiatan: kegiatanList[index]),
                        ),
                      );
                    },
                  ),
